...
import com.lilypuree.decorative_blocks.items.GoldSparkles;
...
//    public static final RegistryObject<Item> HAY_BUCKET = ITEMS.register("hay_bucket",() -> new BucketItem(STILL_HAY, (new Item.Properties()).containerItem(Items.BUCKET).maxStackSize(1).group(ModSetup.ITEM_GROUP)));
    ...
    public static final RegistryObject<Block> GOLD_SPRINKLES = BLOCKS.register("gold_sprinkles", () -> new GoldSprinkleBlock(Block.Properties.create(Material.AIR).noDrops().doesNotBlockMovement()));
    public static final RegistryObject<Item> GOLD_SPARKLES = ITEMS.register("gold_sparkles", () -> new GoldSparkles(modItemProperties));
    public static final RegistryObject<BasicParticleType> GOLD_PARTICLE = PARTICLES.register("gold", () -> new BasicParticleType(false));
